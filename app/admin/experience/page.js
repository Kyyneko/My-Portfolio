...
import { getExperience, upsertExperience, deleteExperience } from '@/lib/data';
    ...
    return (
        <div>
            ...
            <div className={styles.itemList}>
                ...
                {items.length === 0 && <p style={{ color: 'var(--text-muted)', textAlign: 'center', padding: '2rem' }}>No experience entries yet.</p>}
            </div>
                ...
                <div className={styles.modal} onClick={() => setEditing(null)}>
                    <div className={styles.modalContent} onClick={e => e.stopPropagation()}>
                        ...
                        <div className={styles.formGrid}>
                            ...
                            <div className="form-group"><label className="form-label">Start Date</label><input type="month" className="form-input" value={editing.start_date} onChange={e => update('start_date', e.target.value)} /></div>
                            <div className="form-group"><label className="form-label">End Date</label><input type="month" className="form-input" value={editing.end_date || ''} onChange={e => update('end_date', e.target.value)} disabled={editing.is_current} /></div>
                            <div className="form-group">
